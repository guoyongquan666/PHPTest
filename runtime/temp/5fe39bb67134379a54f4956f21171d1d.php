<?php /*a:1:{s:64:"/usr/local/nginx/html/tp5/application/admin/view/index/index.php";i:1557986520;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <link href="/static/ui/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="/static/ui/img/profile_small.jpg" /></span>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">JBBis-BaB</strong></span>
...
<!--                        </ul>-->
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<?php echo url('admin/Company/lists'); ?>" data-index="0">企业列表</a>
                        </li>
<!--                        <li>-->
...
<!--                </li>-->
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li class="m-t-xs">
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/static/ui/img/a7.jpg">
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/static/ui/img/a4.jpg">
                                    </a>
                                    <div class="media-body ">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?php echo url('admin/Index/index1'); ?>" frameborder="0" data-id="index_v1.html" seamless></iframe>
        </div>
        <div class="footer">
            <div class="pull-right">&copy;2019-2020  <a href="http://www.zi-han.net/" target="_blank">JBB's blog</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
...
<!--                                    <img alt="image" class="img-circle message-avatar" src="/static/ui/img/a1.jpg">-->
<!---->
<!--                                    <div class="m-t-xs">-->
...
<!--                            <a href="#">-->
<!--                                <div class="pull-left text-center">-->
<!--                                    <img alt="image" class="img-circle message-avatar" src="/static/ui/img/a2.jpg">-->
<!--                                </div>-->
<!--                                <div class="media-body">-->
...
<!--                            <a href="#">-->
<!--                                <div class="pull-left text-center">-->
<!--                                    <img alt="image" class="img-circle message-avatar" src="/static/ui/img/a3.jpg">-->
<!---->
<!--                                    <div class="m-t-xs">-->
<!--                                        <i class="fa fa-star text-warning"></i>-->
<!--                                        <i class="fa fa-star text-warning"></i>-->
...
<!--                            <a href="#">-->
<!--                                <div class="pull-left text-center">-->
<!--                                    <img alt="image" class="img-circle message-avatar" src="/static/ui/img/a4.jpg">-->
<!--                                </div>-->
<!---->
<!--                                <div class="media-body">-->
<!--                                    国外极限小子的炼成！这还是亲生的吗！！-->
...
<!--                            <a href="#">-->
<!--                                <div class="pull-left text-center">-->
<!--                                    <img alt="image" class="img-circle message-avatar" src="/static/ui/img/a8.jpg">-->
<!--                                </div>-->
<!--                                <div class="media-body">-->
<!---->
...
<!--                            <a href="#">-->
<!--                                <div class="pull-left text-center">-->
<!--                                    <img alt="image" class="img-circle message-avatar" src="/static/ui/img/a7.jpg">-->
<!--                                </div>-->
<!--                                <div class="media-body">-->
...
<script type="text/javascript" src="/static/ui/js/contabs.js"></script>

<!-- 第三方插件 -->
<script src="/static/ui/js/plugins/pace/pace.min.js"></script>
